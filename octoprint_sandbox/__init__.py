...
class SandboxPlugin(octoprint.plugin.SettingsPlugin,
	...
	def get_update_information(self):
		...
		return dict(
			sandbox=dict(
				...
				type="github_release",
				user="OllisGit",
				repo="OctoPrint-Sandbox",
				current=self._plugin_version,

				# update method: pip
				pip="https://github.com/OllisGit/OctoPrint-Sandbox/archive/{target_version}.zip"
			)
		)
...
__plugin_name__ = "Sandbox Plugin"
...
def __plugin_load__():
	...
	__plugin_implementation__ = SandboxPlugin()
